  ...
  Future<void> _seedDestinations(Database db) async {
              final destinations = [
                  ...
                  const DestinationModel(
                    id: 5,
                    name: 'Managua',
                    description: 'Capital de Nicaragua, con espacios urbanos, lagunas y oferta cultural.',
                    imageUrl: 'assets/images/managua.jpg',
                    mapImageUrl: 'assets/maps/managua_map.png',
                    category: 'Cultural',
                  ...
                  const DestinationModel(
                    id: 6,
                    name: 'Boaco',
                    description: 'Ciudad del centro del país reconocida por su entorno natural y clima agradable.',
                    imageUrl: 'assets/images/boaco.jpg',
                    mapImageUrl: 'assets/maps/boaco_map.png',
                    category: 'Naturaleza',
                    locationName: 'Boaco, Nicaragua',
                    latitude: 12.472,
                    longitude: -85.658,
                  ),
                ];
